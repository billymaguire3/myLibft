...
#    Updated: 2020/02/10 18:24:02 by wimaguir         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FUNC = ft_putchar.c ft_putstr.c ft_strlen.c ft_strcpy.c ft_strncpy.c ft_strcmp.c ft_strncmp.c ft_putnbr.c ft_atoi.c \
	   ...
	   ft_strmap.c ft_strmapi.c ft_strequ.c ft_strnequ.c ft_strsub.c ft_strjoin.c ft_strtrim.c ft_isspace.c \
...
OBJECTS = ft_putchar.o ft_putstr.o ft_strcpy.o ft_strncpy.o ft_strlen.o ft_strcmp.o ft_strncmp.o ft_putnbr.o ft_atoi.o \
		  ...
		  ft_strmap.o ft_strmapi.o ft_strequ.o ft_strnequ.o ft_strsub.o ft_strjoin.o ft_strtrim.o ft_isspace.o \
